    ...
    return (
      <main className="page-shell page-shell-top">
        <section className="hero-card insights-card">
          ...
          <h1>Insights</h1>
          <p className="intro">
            Useful observations generated only from saved shift data, with exact dates when available.
          </p>
            ...
            {data.insights.length > 0 ? (
              ...
              <div className="empty-state">
                ...
                <p className="status-copy">
                  Add more saved shifts to build stronger observations from the journal data.
                </p>
              </div>
            )}
          </div>
    ...
    return (
      <main className="page-shell page-shell-top">
        <section className="hero-card insights-card">
          ...
          <p className="eyebrow">AI insights</p>
          <h1>Insights</h1>
          <p className="intro">Useful observations generated from saved shift data.</p>

          <div className="status-banner status-error" role="alert">
            <p className="status-title">Insights are temporarily unavailable.</p>
            ...
            <p className="status-copy">
              ...
              <code> /api/ai/insights</code> returns JSON.
            </p>
          </div>
        </section>
      </main>
